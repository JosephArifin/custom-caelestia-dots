# -------------------
# MOVE / REPLACE THIS FILE IN /usr/lib/{python version}/site-packages/caelestia
# Done after installing caelestia cli here:
# https://github.com/caelestia-dots/cli/tree/main
# -------------------
import json
import shlex
import shutil
    ...
    def __init__(self, args: Namespace) -> None:
        ...
        self.cfg = {
            ...
            "todo": {
                ...
                "taskwarrior-tui": {
                    "enable": True,
                    "match": [{"class": "taskwarrior", "title": "taskwarrior-tui", "workspace": {"name": "special:todo"}}],
                    "command": ["foot", "-a", "taskwarrior", "-T", "taskwarrior-tui", "fish", "-C", "exec taskwarrior-tui"],
                    "move": True,
                },
            },
        }
